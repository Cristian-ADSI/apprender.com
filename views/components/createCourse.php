<div class="modal fade" id="courseModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="profesor.php?view=listCourses" enctype="multipart/form-data" method="POST">
                <div class="modal-body">

                    <div class="mb-3">
                        <input type="text" class="form-control" name="courseName" placeholder="Nombre del curso">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" name="CourseValue" placeholder="Valor del curso">
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="courseDesc">Descripcion del curso</label>
                        <textarea class="form-control mb-3" id="courseDesc" name="courseDesc"></textarea>

                        <label class="form-label" for="courseImage">Caratula</label>
                        <input id="courseImage" type="file" name="courseImage">
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" name="createCourse" class="btn btn-success">Guardar Cambios</button>
                </div>
            </form>
